                  ...
                  <div className="flex flex-col items-center space-y-8">
                    ...
                    <div className="flex max-w-2xl flex-col space-y-1">
                      <h3 className="p-0 text-center font-sans text-xl font-normal tracking-tight text-muted-foreground">
                        ...
                        intuitive Todo List Web App. Start organizing your life
                ...
                <div className="grid w-full grid-cols-1 gap-4 space-y-0 lg:grid-cols-3">
                  <Card className="relative col-span-2 overflow-hidden lg:h-96">
                    <CardHeader>
                      ...
                      An intuitive dashboard to organize and track all your tasks efficiently.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <Image
                  ...
                  <Card className="relative col-span-2 w-full overflow-hidden lg:col-span-1">
                    <CardHeader>
                      ...
                      <CardDescription className="max-w-xs text-sm font-semibold tracking-tight">
                      Our app supports multiple sign-in options to make accessing your tasks quick and secure.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <Image
                  ...
                  <Card className="relative col-span-2 overflow-hidden lg:col-span-1 lg:h-96">
                    <CardHeader>
                      ...
                      <CardDescription className="max-w-xs text-sm font-semibold tracking-tight">
                      Allow multiple users to manage their tasks separately with individual accounts.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <Image
                  ...
                  <Card className="relative col-span-2 overflow-hidden lg:h-96">
                    <CardHeader>
                      ...
                      <CardDescription className="max-w-xs text-sm font-semibold tracking-tight">
                      Sync your tasks across devices in real-time to stay updated no matter where you are.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <Image
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex flex-col space-y-4">
                  <div>
                    ...
                    Organize tasks, track progress, and stay focused—all in one place.
                    </p>
                  </div>
